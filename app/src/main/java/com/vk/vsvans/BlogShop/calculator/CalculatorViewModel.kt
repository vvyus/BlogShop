package com.vk.vsvans.BlogShop.calculator
...
class CalculatorViewModel : ViewModel() {
    ...
    fun operandPressed(op: String) {
        ...
        val numFormatted = {
            (
                    if (previousNumber.absoluteValue.rem(1).equals(0.0))
                        previousNumber.toInt()
                    else (previousNumber*1000).roundToInt()/1000.0
                    ).toString()
        }
