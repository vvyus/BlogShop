...
object DbName {
  ...
  // Table Purchase
        ...
        const val CREAT_TABLE_SELLERS = "CREATE TABLE IF NOT EXISTS $TABLE_NAME_SELLERS (" +
                "${BaseColumns._ID} INTEGER PRIMARY KEY,$COLUMN_NAME_TITLE_SELLERS TEXT,$COLUMN_NAME_DESCRIPTION_SELLERS TEXT" +
                ")"
      ...
      const val COLUMN_NAME_PRODUCT_ID = "idproduct"
        ...
        const val CREAT_TABLE_PURCHASE_ITEMS = "CREATE TABLE IF NOT EXISTS $TABLE_NAME_PURCHASE_ITEMS (" +
                "${BaseColumns._ID} INTEGER PRIMARY KEY,$COLUMN_NAME_PURCHASE_ID INTEGER,$COLUMN_NAME_PRICE DOUBLE," +
                "$COLUMN_NAME_QUANTITY DOUBLE,$COLUMN_NAME_SUMMA DOUBLE,$COLUMN_NAME_PRODUCT_ID INTEGER,$COLUMN_NAME_PRODUCT_NAME TEXT"+
                ")"
    ...
    const val CREAT_TABLE_PRODUCTS = "CREATE TABLE IF NOT EXISTS $TABLE_NAME_PRODUCTS (" +
            "${BaseColumns._ID} INTEGER PRIMARY KEY,$COLUMN_NAME_TITLE_PRODUCTS TEXT,$COLUMN_NAME_BCOLOR_PRODUCTS INTEGER" +
            ",$COLUMN_NAME_FCOLOR_PRODUCTS INTEGER)"
